...
# Hi there 👋, I'm Emmanuel Ekong

### Frontend Developer • Full-Stack JavaScript Developer • Open Source Contributor

Building performant, scalable, and user-focused web applications with modern JavaScript technologies.

<p>
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&pause=1200&center=true&vCenter=true&width=700&lines=Frontend+Developer;React+%7C+Next.js+%7C+TypeScript;Building+Software+That+Creates+Value;Learning+In+Public;Open+Source+Contributor" alt="Typing SVG"/>
</p>
...
- 🚀 Creating production-ready SaaS products
...
A campus marketplace connecting student buyers and vendors through a secure and user-friendly shopping experience.
...
Corporate website built with performance, accessibility, and conversion optimization as core priorities.
...
My goal is to become a consistent open-source contributor by solving real problems, collaborating with maintainers, and learning from large production codebases.

---

# 🎯 2026 Goals

- Contribute 50+ merged Pull Requests
...
> **"Write code that solves problems, build products that create value, and never stop learning."**
...
I'm always open to collaborating on interesting projects, contributing to open source, or discussing software engineering.
